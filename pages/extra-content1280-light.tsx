...
const ExtraContent1280Light: NextPage = () => {
  ...
  return (
    <div className="w-full relative bg-white overflow-hidden flex flex-row items-end justify-between pt-6 pb-[273px] pr-8 pl-20 box-border gap-[20px] tracking-[normal] text-left text-13xl text-black font-portfolio-thumbnails-14-18-aa mq725:pl-10 mq725:box-border mq1050:flex-wrap">
